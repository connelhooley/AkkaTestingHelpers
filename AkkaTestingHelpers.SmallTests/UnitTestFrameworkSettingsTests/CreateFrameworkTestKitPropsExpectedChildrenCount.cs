...
namespace ConnelHooley.AkkaTestingHelpers.SmallTests.UnitTestFrameworkSettingsTests
{
    public class CreateFrameworkTestKitPropsExpectedChildrenCount : TestBase
    {
        ...
        public void UnitTestFrameworkSettings_CreateFrameworkWithNullTestKit_ThrowsArgumentNullException()
        {
            ...
            //act
            Action act = () => sut.CreateFramework<DummyChildActor1>(null, PropsPassedIntoSut, ExpectedChildrenCountPassedIntoSut);
        ...
        public void UnitTestFrameworkSettings_CreateFrameworkWithNullProps_ThrowsArgumentNullException()
        {
            ...
            //act
            Action act = () => sut.CreateFramework<DummyChildActor1>(TestKitPassedIntoShim, (Props)null, ExpectedChildrenCountPassedIntoSut);
        ...
        public void UnitTestFrameworkSettingsWithHandlers_CreateFramework_ConstructsTestProbeResolverWithCorrectHandlers()
        {
            ...
            //act
            sut.CreateFramework<DummyParentActor>(this, PropsPassedIntoSut, ExpectedChildrenCountPassedIntoSut);
        ...
        public void UnitTestFrameworkSettings_CreateFramework_ReturnsCreatedOneUnitTestFramework()
        {
            ...
            //act
            UnitTestFramework<DummyParentActor> result = sut.CreateFramework<DummyParentActor>(TestKitPassedIntoSut, PropsPassedIntoSut, ExpectedChildrenCountPassedIntoSut);
