...
namespace ConnelHooley.AkkaTestingHelpers.SmallTests.UnitTestFrameworkTests
{
    public class Constructor : TestBase
    {
        ...
        [Fact]
        public void UnitTestFramework_ConstructorWithNullTestProbeParentActorCreator_ThrowsArgumentNullException()
        {
            //act
            Action act = () => new UnitTestFramework<DummyActor>(
                SutCreator,
        ...
        [Fact]
        public void UnitTestFramework_ConstructorWithNullDelayer_ThrowsArgumentNullException()
        {
            //act
            Action act = () => new UnitTestFramework<DummyActor>(
                SutCreator,
